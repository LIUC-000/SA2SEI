...
def main():
    ...
    X_train_ul, Y_train_ul = PreTrainDataset_prepared(params['ft'], range(params['class_start'], params['class_end']+1))
    ...
    optimizer = torch.optim.Adam(list(online_network.parameters()) + list(predictor.parameters()), lr=params['lr'], weight_decay=params['weight_decay'])
